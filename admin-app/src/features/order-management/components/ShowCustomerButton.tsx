export const ShowCustomerButton = ({ title }: { title: string }) => {
    return (
        <button
            className="shadow w-full flex items-center gap-3 p-3 bg-gradient-to-r from-green-50 to-green-100 text-green-700 rounded-xl hover:from-green-100 hover:to-green-200 transition-all duration-200 font-medium"
        >
            <svg
                className="w-5 h-5"
                fill="none"
